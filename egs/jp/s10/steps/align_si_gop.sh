...
if $use_graphs; then
  ...
  $cmd JOB=1:$nj $dir/log/align.JOB.log \
    gmm-align-compiled-gop $scale_opts --beam=$beam --retry-beam=$retry_beam --careful=$careful "$mdl" \
  ...
  $cmd JOB=1:$nj $dir/log/align.JOB.log \
    ...
    gmm-align-compiled-gop $scale_opts --beam=$beam --retry-beam=$retry_beam --careful=$careful "$mdl" ark:- \
